...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-blue">
      ...
      <main className="container mx-auto py-12 px-4 max-w-3xl relative z-0">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-20 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl flex flex-col items-center">
              ...
              <p className="text-lg font-medium">
                {isLoading ? "Enhancing your prompt..." : "Generating Swagger API..."}
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                Using {aiProvider?.provider === "anthropic" ? "Anthropic" : "OpenAI"} {aiProvider?.model || ""} to{" "}
                {isLoading ? "improve your prompt" : "create your API specification"}
              </p>
            </div>
          </div>
        )}
